...
export default () => {
    return (
        <section className="w-full h-screen flex flex-col items-center justify-center bg-gradient-to-r from-orange-400 via-orange-500 to-red-500">
            <div className="flex flex-col md:flex-row items-center justify-center">
                <div className="rounded-full bg-white w-36 hover:w-[155px] md:hover:w-[265px] transition-all duration-300 md:w-64 overflow-hidden shadow-lg md:mb-0 mb-10 animate-slideInLeft">
